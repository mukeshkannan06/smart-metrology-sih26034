...
const ruleDatabaseContent = `import React, { useState, useEffect } from 'react';
import {
  Database,
  Search,
  ShieldCheck,
...
const ruleReferenceContent = `import React, { useState, useEffect } from 'react';
import {
  Search,
  ExternalLink,
  RefreshCw,
...
const ruleDbPath = path.join(rootDir, 'frontend', 'src', 'pages', 'controller', 'RuleDatabase.tsx');
const ruleRefPath = path.join(rootDir, 'frontend', 'src', 'pages', 'inspector', 'RuleReference.tsx');

fs.writeFileSync(ruleDbPath, ruleDatabaseContent, 'utf8');
console.log('Successfully wrote clean RuleDatabase.tsx to:', ruleDbPath);

fs.writeFileSync(ruleRefPath, ruleReferenceContent, 'utf8');
console.log('Successfully wrote clean RuleReference.tsx to:', ruleRefPath);
